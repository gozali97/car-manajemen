    ...
    <nav class="bg-white dark:bg-gray-800 fixed w-full z-20 top-0 start-0 scroll-smooth dark:border-gray-600">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <Link :href="route('home')" class="flex items-center space-x-3  rtl:space-x-reverse">
                <img src="https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="h-6 w-9 lg:h-8 rounded-full" alt="Logo" />
                <span class="self-center text-sm lg:text-2xl font-semibold whitespace-nowrap dark:text-white">CarRent</span>
            </Link>
