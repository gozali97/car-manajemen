...
const addToCart = (product) => {
    // console.log(product)
    router.post(route('transaksi.store', product), {
        onSuccess: (page) => {
            ...
            <section class="text-gray-600 body-font overflow-y-auto h-full">
                <div class="container px-5 py-24 mx-auto ">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 rounded-lg bg-white dark:bg-gray-800 px-10 py-12">
                        <div class="w-full">
                            <div class="">
                                <img v-if="product.image" class="w-full h-52 lg:h-[500px] object-cover object-center rounded" :src="`/${product.image}`">
                                <img v-else class="w-full lg:h-auto h-64 object-cover object-center rounded" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/330px-No-Image-Placeholder.svg.png">
                            </div>
                        </div>
