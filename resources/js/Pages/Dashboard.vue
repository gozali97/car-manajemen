                ...
                <div class="mt-6 overflow-hidden rounded-xl border shadow">
                    <table class="min-w-full border-separate border-spacing-y-2 border-spacing-x-2">
                        ...
                        <tr class="">
                            ...
                            <td class="whitespace-normal py-4 text-sm font-medium text-gray-500 sm:px-6">Start Date</td>
                            <td class="whitespace-normal py-4 text-sm font-medium text-gray-500 sm:px-6">End Date</td>
